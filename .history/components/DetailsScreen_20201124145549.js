    ...
    <View style={styles.container}>
      ...
      <View style={{ flex: 1 }}>
        ...
        <ScrollView>
          ...
          >
            <Text style={{ ...FONTS.h2 }}>Contact Information</Text>
            <Text
              style={{
                marginTop: SIZES.radius,
                color: COLORS.gray,
            ...
            >
              Address {route.params.hotel.Address}
            </Text>
            <Text
              style={{
                marginTop: SIZES.radius,
            ...
            >
              Contact No {route.params.hotel.Contactno}
            </Text>
            <Text
              style={{
                marginTop: SIZES.radius,
            ...
            >
              Website{route.params.hotel.Contactno}
            </Text>
          </View>
          {/* Footer */}
          <View style={{ flex: 0.5, paddingHorizontal: SIZES.padding }}>
            ...
            >
              ...
              >
                ...
                >
                  <Text style={{ ...FONTS.h1 }}>
                    RS {route.params.hotel.Cost}/=
                  </Text>
                  <Text style={{ ...FONTS.h1 }}>Per Night</Text>
                </View>
